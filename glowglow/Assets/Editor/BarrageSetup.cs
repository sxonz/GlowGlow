...
public static class BarrageSetup
{
    ...
    public static void InstallOverdrive()
    {
        ...
        catalog.cards[5].description = "최대 5초간 이동 속도 150%와 관성, 보호막 3을 얻습니다. 총구 대신 몸에 붙은 회전 가시로 공격합니다. 보호막 소진 또는 시간 종료 시 원래 상태로 돌아옵니다. 쿨타임 10초.";
    ...
    public static void InstallElectricPulse()
    {
        ...
        catalog.cards[4].description = "피해 없이 주변으로 전기 펄스를 방출합니다. 적을 조금 밀어내고 0.3초 동안 이동 속도를 75%로 낮춥니다. 범위 3, 쿨타임 2초.";
        EditorUtility.SetDirty(catalog);
    ...
    public static void Install()
    {
        ...
        Configure(catalog.cards[1].weapon, "Laser Shot", 1f, new[]
        {
            new BarrageStep { shape = BarrageShape.Line, dealsDamage = false, duration = 1, startSize = .1f, peakSize = 2, growTime = 1 },
            new BarrageStep { shape = BarrageShape.Box, delay = 1, dimensions = new Vector2(20, .3f), duration = .5f, flash = true }
        }, 1);
        ...
        catalog.cards[1].description = "1초간 예고선을 표시한 뒤 길이 20, 두께 0.3의 레이저를 0.5초간 발사합니다. 쿨타임 1초.";
