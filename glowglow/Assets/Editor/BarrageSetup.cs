...
public static class BarrageSetup
{
    ...
    public static void Install()
    {
        ...
        Configure(catalog.cards[1].weapon, "Laser Shot", 2f, new[]
        {
        ...
        catalog.cards[1].description = "총구를 따라가는 예고선 1초 후 레이저를 0.5초간 발사하며 뒤로 반동을 받습니다. 예고와 발사 중 감속하고 초당 최대 30도로 조준합니다. 종료 후 커서로 빠르게 회전합니다. 쿨타임 2초.";
